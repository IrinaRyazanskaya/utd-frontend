    ...
    <article className="privacy">
      ...
      <ol className="privacy__list">
        ...
        <li className="privacy__list-item">
          ...
          <ol className="privacy__sub-items-list">
            <li className="privacy__sub-item">3.1. Фамилия, имя, отчество;</li>
            <li className="privacy__sub-item">3.2. Электронный адрес;</li>
            <li className="privacy__sub-item">3.3. Номера телефонов;</li>
            <li className="privacy__sub-item">
        ...
        <li className="privacy__list-item">
          ...
          <ol className="privacy__sub-items-list">
            <li className="privacy__sub-item">
              ...
              посредством отправки электронных писем; прием заявок от Пользователя на покупку
              товаров; установление обратной связи с Пользователем сайта{" "}
              <strong>https://utd174.ru</strong>.
            </li>
            <li className="privacy__sub-item">
              ...
              электронной почты <strong>89193151000@mail.ru</strong> с пометкой «Отказ от
        ...
        <li className="privacy__list-item">
          ...
          <ol className="privacy__sub-items-list">
            <li className="privacy__sub-item">
              ...
              <strong>https://utd174.ru</strong>. Заполняя соответствующие формы и/или отправляя
        ...
        <li className="privacy__list-item">
          ...
          <ol className="privacy__sub-items-list">
            ...
            <li className="privacy__sub-item">
              ...
              <strong>89193151000@mail.ru</strong> с пометкой «Актуализация персональных данных».
            </li>
            <li className="privacy__sub-item">
              ...
              Оператора&nbsp;
              <strong>89193151000@mail.ru</strong> с пометкой «Отзыв согласия на обработку
              персональных данных».
            </li>
          </ol>
        </li>
        ...
        <li className="privacy__list-item">
          ...
          <ol className="privacy__sub-items-list">
            ...
            <li className="privacy__sub-item">
              ...
              адресу <strong>https://utd174.ru/privacy</strong>.
            </li>
          </ol>
        </li>
      </ol>
